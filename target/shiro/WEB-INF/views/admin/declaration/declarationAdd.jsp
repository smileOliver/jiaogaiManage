    ...
    <div data-options="region:'center',border:false" style="overflow: hidden;padding: 3px;" >
        <form id="declarationAddForm" method="post">
            <table class="grid">
                <tr>
                    <td>申报信息标题</td>
                    <td><input name="declarationTitle" type="text" placeholder="请输入申报信息标题" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td>内容</td>
                    <td colspan="8"><textarea name="declarationContent"></textarea></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td >
