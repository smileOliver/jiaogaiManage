...
//		strategy.setTablePrefix(new String[] { "bmd_", "mp_" });// 此处可以修改为您的表前缀
		...
		// 自定义 controller 父类
		strategy.setSuperControllerClass("com.ermizhou.commons.base.BaseController");
		...
		pc.setParent("com.ermizhou"); // 自定义包路径
