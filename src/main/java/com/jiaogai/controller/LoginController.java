...
import com.jiaogai.commons.csrf.CsrfToken;
import com.jiaogai.commons.shiro.captcha.DreamCaptcha;
import com.jiaogai.commons.utils.StringUtils;
import com.jiaogai.model.User;
import com.jiaogai.service.IUserService;
...
public class LoginController extends BaseController {
    ...
    public Object loginPost(HttpServletRequest request, HttpServletResponse response,
        ...
        //设置session信息
        User user2=userService.selectByLoginName(username);
        user.getSession().setAttribute("user", user2);
