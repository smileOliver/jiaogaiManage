    ...
    <div data-options="region:'center',border:false" style="overflow: auto;padding: 3px;" >
        <form id="noticeAddForm" method="post">
            <table class="grid">
                <tr>
                    <td>公告标题</td>
                    <td><input name="noticeTitle" type="text" placeholder="请输入公告标题" class="easyui-validatebox span2" data-options="required:true" value=""></td>
                </tr>
                <tr>
                    <td>内容</td>
                    <td colspan="4"><textarea name="noticeContent" style="width: 360px;height: 127px;"></textarea></td>
                </tr>
                <tr>
                    <td>状态</td>
                    <td >
