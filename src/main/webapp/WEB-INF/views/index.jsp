...
<body>
    ...
    <div id="index_layout">
        <div data-options="region:'north',border:false" style="overflow: hidden;">
            <div class="head-backImg">
                <span style="float: right; padding-right: 20px; margin-top: 3px; color: #333">
                    <i class="fi-torso"></i>
                ...
                <!-- <span class="header" style="font-size: 20px;margin-left:200px;margin-top:10px;">教改项目申报管理系统</span> -->
        ...
        <div data-options="region:'center'" style="overflow: auto;">
            <div id="index_tabs" style="overflow: auto;">
                <div title="首页" data-options="iconCls:'fi-home',border:false" style="overflow: hidden;">
                    <div class="home" style="background: url(${staticPath }/static/style/images/body_bg.png) no-repeat;
                    width:100%;height:100%;margin-top:-40px;">
                    <h1 style="font-size: 60px;color: green;">教改项目申报管理系统</h1>
                    </div>
                    <style>
        ...
        <!-- 首页结束 -->
        <div data-options="region:'south',border:false" style="height: 30px;line-height:30px; overflow: hidden;text-align: center;background-color: #eee" >Copyright © 2018 power by <a href="#" target="_blank">二米粥技术</a></div>
    </div>
    <div id="tabsMenu">
